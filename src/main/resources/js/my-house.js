...
function showMyHouse() {
    ...
    let str = `<div class="row"><button class="mt-4 mx-4 btn-nav" style="border: 2px solid black" data-toggle="modal" data-target="#exampleModal" onclick="showAddForm()">Thêm nhà</button></div>
